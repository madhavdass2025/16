...
$products_result = $mysqli->query("SELECT p.product_id, p.product_name, c.category_name, p.mrp, p.tax_rate FROM products p LEFT JOIN categories c ON p.category_id = c.category_id ORDER BY p.product_name ASC");
